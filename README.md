...
local grabtab = Window:CreateTab("掴む系と紐系", 7733954884)
...
local blobtab = Window:CreateTab("巨人系", 7733916988)
...
local toytab = Window:CreateTab("おもちゃ系", 7733946818)

	toytab:CreateSection("爆発")
...
Modules.DisplayMessage("Made by Jose", "Verbal Hub")
local Modules = {}
Modules.Services = {
    RunService = game:GetService("RunService"),
    StarterGui = game:GetService("StarterGui")
